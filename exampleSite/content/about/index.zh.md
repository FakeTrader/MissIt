...
> [:(far fa-kiss-wink-heart fa-fw): MissIt](https://github.com/eegod/MissIt) 是一个由 [Dillon](https://dillonzq.com) 开发的**简洁**、**优雅**且**高效**的 [Hugo](https://gohugo.io/) 博客主题。
>
> 它的原型基于 [LeaveIt 主题](https://github.com/liuzc/LeaveIt) 和 [KeepIt 主题](https://github.com/Fastbyte01/KeepIt)。

![Hugo 主题 MissIt](/images/Apple-Devices-Preview.png "Hugo 主题 MissIt")
...
MissIt 根据 **MIT** 许可协议授权。

更多信息请查看 [LICENSE 文件](https://github.com/eegod/MissIt/blob/master/LICENSE)。
