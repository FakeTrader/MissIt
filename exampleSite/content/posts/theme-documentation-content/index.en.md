...
description: "Find out how to create and organize your content quickly and intuitively in MissIt theme."
resources:
- name: "featured-image"
...
Find out how to create and organize your content quickly and intuitively in **MissIt** theme.
...
**MissIt** theme uses the summary of the content to display abstract information in the home page. Hugo can generate summaries of your content.
...
You may add the `<!--more-->` summary divider at the start of the article. Keep content that comes before the summary divider empty. Then **MissIt** theme will use your description as the summary.
...
**MissIt** theme has some extended syntax elements for you to write articles.
...
**MissIt** theme supports mathematical formulas based on [$ \KaTeX $](https://katex.org/).
...
An extended Markdown syntax for **ruby annotation** is supported in **MissIt** theme:
...
An extended Markdown syntax for **fraction** is supported in **MissIt** theme:
...
**MissIt** theme uses [Font Awesome](https://fontawesome.com/) as the icon library.
