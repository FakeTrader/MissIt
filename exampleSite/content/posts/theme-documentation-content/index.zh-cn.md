...
description: "了解如何在 MissIt 主题中快速, 直观地创建和组织内容."
resources:
- name: "featured-image"
...
**MissIt** 主题使用内容摘要在主页中显示大致文章信息。Hugo 支持生成文章的摘要.
...
你仍然需要在文章开头添加 `<!--more-->` 摘要分割符. 将摘要分隔符之前的内容保留为空. 然后 **MissIt** 主题会将你的文章描述作为摘要.
...
**MissIt** 基于 [$ \KaTeX $](https://katex.org/) 提供数学公式的支持.
...
**MissIt** 主题支持一种 **字符注音或者注释** Markdown 扩展语法:
...
**MissIt** 主题支持一种 **分数** Markdown 扩展语法:
...
**MissIt** 主题使用 [Font Awesome](https://fontawesome.com/) 作为图标库.
你同样可以在文章中轻松使用这些图标.
